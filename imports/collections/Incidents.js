...
Schemas.formSchema = new SimpleSchema({
  ...
  "checklist.carOff": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.safePlace": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.medicalAttention": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.call911": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.waitForPolice": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.admitFault": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.discussAccident": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.diminishInjury": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.acceptPayment": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.cooperate": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.collectInformation": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.operatorsReport": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.notifyInsurance": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.seekMedicalAttention": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.consultAttorney": {type: Boolean, optional: true, srf: {type: TextInput}},
  "checklist.getWhiplashInfo": {type: Boolean, optional: true, srf: {type: TextInput}},
  //driver info
  ...
  //time & location
  "timeLocation.date": {type: String, optional: true, srf: {type: DateInput}},
