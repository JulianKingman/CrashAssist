...
export default class Landing extends Component {
    ...
    renderLoginDialog = ()=> {
        if (this.state.showLoginDialog) {
            return (
                <Popover
                    getTarget={()=>{return this.refs.menuActuator}}
                ...
                >
                    <p>Congrats, you completed filling out an incident report! If you need to access or edit your
                        report, or set up your email and password to access your report on
                        <a href="https://crashassistapp.com">crashassistapp.com</a>, click this menu icon.</p>
                </Popover>
            )
        }
    };
...
export default LandingContainer = createContainer(()=> {
    ...
    return {
        ...
        hideLoginDialog: !Meteor.user()['profile.hideLoginDialog']
    }
}, Landing);